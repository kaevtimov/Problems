...
public class DogeCoin {
    ...
    public static ArrayList<Integer> numbers = new ArrayList<>();  // tova sa mi koordinatite
    ...
    public static void main(String[] args){
        ...
        matrix = new int[R][C];                                         // tova mi e matricata
        for (int i = 0; i < numbers.size()-1; i+=2) {
            int row = numbers.get(i);   // purviq koordinat
            int col = numbers.get(i+1);  // vtoriq koordinat
            matrix[row][col]++;
        }
